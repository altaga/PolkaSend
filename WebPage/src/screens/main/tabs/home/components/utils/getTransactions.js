...
export const getAcala = async (address) => {
    return new Promise((resolve, reject) => {
        var config = {
            method: 'get',
            url: `https://blockscout.mandala.acala.network/api?module=account&action=txlist&address=${address}&startblock=1&endblock=99999999&sort=desc`,
            headers: {}
        };
        axios(config)
            .then((response) => {
